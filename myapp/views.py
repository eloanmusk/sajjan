...
def index(request):
    return HttpResponse('Hello Sajjan!')
...
#class based view for above product detail view (List View)
...
# class based view for Update Product (UpdateVIew)
...
# class based delete view (DeleteView)
